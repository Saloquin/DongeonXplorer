        ...
        tailwind.config = {
            theme: {
                extend: {
                    ...
                    backgroundSize: {
                        'larger': '100%',  // Ajouter une taille plus grande
                    },
                },
            },
        };
...
<body class="bg-background-home bg-larger text-textMain font-body min-h-screen background-home bg-fixed">
    ...
    <nav class="bg-transparent relative">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <button data-collapse-toggle="navbar-default" type="button" class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-300 rounded-lg md:hidden hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-600" aria-controls="navbar-default" aria-expanded="false">
                <span class="sr-only">Open main menu</span>
                <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 17 14">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 1h15M1 7h15M1 13h15" />
                </svg>
            </button>
            <!-- Added ml-auto here to push the links to the right -->
            <div class="hidden w-full md:block md:w-auto ml-auto" id="navbar-default">
                <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 rounded-lg bg-opacity-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:bg-transparent">
                    <li>
                        <a href="register" class="block py-2 px-3 text-gray-300 rounded transition duration-300 ease-in-out hover:bg-gray-800 hover:bg-opacity-50 md:hover:bg-transparent md:hover:text-accentGold md:p-0">
                            S'inscrire
                        </a>
                    </li>
                    <li>
                        <a href="login" class="block py-2 px-3 text-gray-300 rounded transition duration-300 ease-in-out hover:bg-gray-800 hover:bg-opacity-50 md:hover:bg-transparent md:hover:text-accentGold md:p-0">
                            Se connecter
                        </a>
                    </li>
                </ul>
